...
#ifndef SHERPA_ONNX_CSRC_OFFLINE_WHISPER_GREEDY_SEARCH_DECODER_OPT_H_
#define SHERPA_ONNX_CSRC_OFFLINE_WHISPER_GREEDY_SEARCH_DECODER_OPT_H_
...
class OfflineWhisperGreedySearchDecoderOpt : public OfflineWhisperDecoder {
 public:
  OfflineWhisperGreedySearchDecoderOpt(const OfflineWhisperModelConfig &config,
                                       OfflineWhisperModelOpt *model)
...
#endif  // SHERPA_ONNX_CSRC_OFFLINE_WHISPER_GREEDY_SEARCH_DECODER_OPT_H_
